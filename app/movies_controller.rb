...
def can_be_created_with_a_hash_of_attributes
  ...
  # the previous does Movie.new + Movie.save
end
...
def can_find_using_where_clause_and_be_sorted
  ...
  Movie.all.where("release_date > 9002").order(release_date: :desc)
end
...
def can_update_multiple_items_at_once
  ...
  #end
  Movie.update(title: "A Movie") # will update every instance in the class !!!
end
